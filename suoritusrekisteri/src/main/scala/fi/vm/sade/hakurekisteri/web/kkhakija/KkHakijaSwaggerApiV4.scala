...
trait KkHakijaSwaggerApiV4
  ...
  val hakijaFields: Seq[ModelField] = Seq(
    ...
    ModelField(
      "hakemukset",
      null,
      ContainerDataType("List", Some(ValueDataType("HakemusV4", None, Some("HakemusV4"))))
    ),
    ModelField(
      "liitteet",
      null,
  ...
  val query: OperationBuilder = apiOperation[Seq[HakijaV4]]("haeKkHakijatV4")
