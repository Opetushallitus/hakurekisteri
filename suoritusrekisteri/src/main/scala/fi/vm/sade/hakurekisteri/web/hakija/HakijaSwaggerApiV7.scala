...
trait HakijaSwaggerApiV7
  ...
  val hakijaFieldsV6 = Seq(
    ...
    ModelField("huoltaja1", null, ValueDataType("JSONHuoltajaV7", None, Some("JSONHuoltajaV7"))),
    ModelField("huoltaja2", null, ValueDataType("JSONHuoltajaV7", None, Some("JSONHuoltajaV7"))),
    ModelField(
  ...
  val queryV7: OperationBuilder = apiOperation[JSONHakijatV7]("haeHakijatV7")
