...
COMMENT ON column siirtotiedostot.window_start IS 'Siirtotiedosto-operaation aikaikkunan alkuhetki (unixtime)';
COMMENT ON column siirtotiedostot.window_end IS 'Siirtotiedosto-operaation aikaikkunan loppuhetki (unixtime)';
