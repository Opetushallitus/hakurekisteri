  ...
  override def receive: Receive = {
    case q: VirtaQuery if q.hetu.contains("123456-789") || q.oppijanumero.contains("123456-789") =>
      ...
      sender ! VirtaResult(
        ...
        Seq(),
        Seq(
          VirtaOpintosuoritus(LocalDate.now(), Some("Inssimatikka 1"), None, Some("5"), Some("Viisiportainen"), "01915", Some("2")),
          VirtaOpintosuoritus(LocalDate.now(), Some("Inssimatikka 2"), None, Some("5"), Some("Viisiportainen"), "01915", Some("2")),
          VirtaOpintosuoritus(LocalDate.now(), Some("Tietotekniikan kandi"), Some("655301"), Some("5"), Some("Viisiportainen"), "01915", Some("1")),
          VirtaOpintosuoritus(LocalDate.now(), Some("Inssifyssa 1"), None, Some("4"), Some("Viisiportainen"), "01915", Some("2")),
          VirtaOpintosuoritus(LocalDate.now(), Some("Inssifyssa 2"), None, Some("5"), Some("Viisiportainen"), "01915", Some("2")),
          VirtaOpintosuoritus(LocalDate.now(), Some("Foobar kurssi"), None, Some("2"), Some("Viisiportainen"), "01915", Some("2"))
        )
      )
    case q: VirtaQuery =>
