...
object CreateDb extends App {
  ...
  def createOppilas(oid:String, aineet: Set[String]) {
    ...
    suoritusJournal.addModification(Updated(VirallinenSuoritus(Config.perusopetusKomoOid, "1.2.246.562.10.39644336305", "KESKEN", kevatJuhla, oid, yksilollistaminen.Ei, "fi",  lahde = "Test").identify(suoritus)))
