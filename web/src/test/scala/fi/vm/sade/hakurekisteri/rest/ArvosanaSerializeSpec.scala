...
class ArvosanaSerializeSpec extends ScalatraFunSuite {
  val arvosana1 = Arvosana(UUID.randomUUID(), None, Arvio410("10"), "AI", None, Some("FI"), valinnainen = false, None, "Test")
  val arvosana12 = Arvosana(UUID.randomUUID(), None, Arvio410("10"), "AI", None, Some("FI"), valinnainen = true, None, "Test", Some(0))
  val arvosana2 = Arvosana(UUID.randomUUID(), None, ArvioYo("L", Some(100)), "AI", None, Some("FI"), valinnainen = false, Some(new LocalDate()), "Test")
  val arvosana3 = Arvosana(UUID.randomUUID(), None, ArvioOsakoe("10"), "AI", None, Some("FI"), valinnainen = false, Some(new LocalDate()), "Test")
