...
trait OppijaSwaggerApi
  ...
  val query = apiOperation[Seq[Oppija]]("haeOppijat")
    ...
    .parameter(queryParam[Option[String]]("ensikertalaisuudenRajapvm")
      .description("ensikertalaisuus ennen tätä ajanhetkeä (ISO 8601 datetime, esim. 2015-09-14T17:51:31Z)").optional)
