...
var httpFixtures = function () {
    ...
    fixtures.organisaatioService = {
        pikkaralaPikkoloOrganisaatioLista: function() {
            httpBackend.when('GET', /.*\/organisaatio-service\/rest\/organisaatio\/v2\/hae\?aktiiviset=true&lakkautetut=false&organisaatiotyyppi=Oppilaitos&searchStr=Pik&suunnitellut=true$/).respond({"numHits":2,"organisaatiot":[{"oid":"1.2.246.562.10.39644336305","alkuPvm":694216800000,"parentOid":"1.2.246.562.10.80381044462","parentOidPath":"1.2.246.562.10.39644336305/1.2.246.562.10.80381044462/1.2.246.562.10.00000000001","oppilaitosKoodi":"06345","oppilaitostyyppi":"oppilaitostyyppi_11#1","match":true,"nimi":{"fi":"Pikkaralan ala-aste"},"kieletUris":["oppilaitoksenopetuskieli_1#1"],"kotipaikkaUri":"kunta_564","children":[],"organisaatiotyypit":["OPPILAITOS"],"aliOrganisaatioMaara":0},{"oid":"1.2.246.562.10.16546622305","alkuPvm":694216800000,"parentOid":"1.2.246.562.10.77047788581","parentOidPath":"1.2.246.562.10.16546622305/1.2.246.562.10.77047788581/1.2.246.562.10.00000000001","oppilaitosKoodi":"05127","oppilaitostyyppi":"oppilaitostyyppi_11#1","match":true,"nimi":{"fi":"Pikkolan koulu"},"kieletUris":["oppilaitoksenopetuskieli_1#1"],"kotipaikkaUri":"kunta_211","children":[],"organisaatiotyypit":["OPPILAITOS"],"aliOrganisaatioMaara":0}]})
        },
        pikkaralaOid: function () {
            httpBackend.when('GET', /.*\/organisaatio-service\/rest\/organisaatio\/1\.2\.246\.562\.10\.39644336305$/).respond(restData.organisaatioService.pikkarala)
        },
        pikkoloOid: function () {
            httpBackend.when('GET', /.*\/organisaatio-service\/rest\/organisaatio\/1\.2\.246\.562\.10\.16546622305/).respond(restData.organisaatioService.pikkolo)
        },
        ...
        pikkoloKoodi: function () {
            httpBackend.when('GET', /.*\/organisaatio-service\/rest\/organisaatio\/05127$/).respond(restData.organisaatioService.pikkolo)
        },
    ...
    fixtures.komoLocal = {
        komoTiedot: function() {
            httpBackend.when('GET', /.*rest\/v1\/komo/).respond(restData.komo)
        }
    }
