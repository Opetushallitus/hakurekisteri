...
var httpFixtures = function () {
    ...
    fixtures.henkiloPalveluService = {
        ...
        aarneHenkiloListana: function () {
            testFrame().httpBackend.when('POST', /.*\/authentication-service\/resources\/henkilo\/henkilotByHenkiloOidList$/, ["1.2.246.562.24.71944845619"]).passThrough()
        },
        aarneJaTyyneHenkiloListana: function () {
            testFrame().httpBackend.when('POST', /.*\/authentication-service\/resources\/henkilo\/henkilotByHenkiloOidList$/, ["1.2.246.562.24.71944845619", "1.2.246.562.24.49719248091", "1.2.246.562.24.76359038731", "1.2.246.562.24.87951154293", "1.2.246.562.24.98743797763"]).passThrough()
        }
    }
