...
//   def getXmlOsaaminen(hakija: Hakija): Future[XMLOsaaminen] = Future.successful(XMLOsaaminen(hakija.hakemus.osaaminen.yleinen_kielitutkinto_sv, hakija.hakemus.osaaminen.valtionhallinnon_kielitutkinto_sv))
