...
object ExcelUtilV4 extends HakijatExcelWriterV3[JSONHakijatV4] {

  private val headers = Seq(
    "Hetu", "Oppijanumero", "Sukunimi", "Etunimet", "Kutsumanimi", "Lahiosoite", "Postinumero", "Postitoimipaikka", "Maa",
    "Kansalaisuudet", "Matkapuhelin", "Muupuhelin", "Sahkoposti", "Kotikunta", "Sukupuoli", "Aidinkieli", "Opetuskieli", "Huoltajan nimi",
  ...
  private def getLisakysymysIdsAndQuestionsInOrder(hakijat: JSONHakijatV4, hakukohdeOid: String): Seq[lisakysymysHeader] = {
  ...
  override def getRows(hakijat: JSONHakijatV4): Set[Row] = {
