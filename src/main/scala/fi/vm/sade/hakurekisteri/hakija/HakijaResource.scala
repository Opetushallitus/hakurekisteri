...
object XMLHakutoive {
  def apply(ht: Hakutoive, jno: Integer, o: Organisaatio, k: String): XMLHakutoive = XMLHakutoive((jno + 1).toShort, k, o.toimipistekoodi, o.nimi.get("fi").orElse(o.nimi.get("sv").orElse(o.nimi.get("en"))),
