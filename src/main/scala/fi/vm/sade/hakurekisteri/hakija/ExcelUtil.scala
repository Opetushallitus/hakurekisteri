...
object ExcelUtil extends HakijatExcelWriter[XMLHakijat] {
  ...
  override def getHeaders: Set[Row] = Set(Row(0)(
    StringCell(0, "Hetu"),
  ...
  override def getRows(hakijat: XMLHakijat): Set[Row] = hakijat.hakijat.flatMap((h) => h.hakemus.hakutoiveet.map(ht => Set[Cell](
    StringCell(0, h.hetu),
    ...
    StringCell(15, toBooleanX(h.koulutusmarkkinointilupa)),
    ...
    StringCell(25, toBooleanX(h.hakemus.julkaisulupa)),
    ...
    StringCell(29, h.hakemus.lisapistekoulutus.getOrElse("")),
