...
trait RekisteritiedotSwaggerApi
  ...
  val queryPost = apiOperation[Seq[Oppija]]("haeOppijatOppijanumeroidenPerusteella")
    .summary("Näyttää oppijoiden tiedot")
    .description(
      "Näyttää listauksen oppijoiden tiedoista parametrien mukaisesti. Vastaava tietorakenne, kuin oppijat-rajapinnassa ilman ensikertalaisuus-tietoja."
    )
    .parameter(
