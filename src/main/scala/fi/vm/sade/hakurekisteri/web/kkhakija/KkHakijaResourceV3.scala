...
class KkHakijaResourceV3(kkHakijaService: KkHakijaService, ophConfig: Config)(implicit system: ActorSystem, sw: Swagger, val security: Security, val ct: ClassTag[Seq[Hakija]])
