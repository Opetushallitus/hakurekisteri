...
object KkExcelUtilV4 extends HakijatExcelWriter[Seq[Hakija]] {
  ...
  private val headers = Seq(
    ...
    "Valinnan tila", "Valintatapajonon tyyppi", "Vastaanottotieto", "Ilmoittautumiset", "Pohjakoulutus", "Julkaisulupa", "Hakukelpoisuus",
    "Hakukelpoisuuden lahde", "Maksuvelvollisuus",
