...
class DateFormatterSpec extends FlatSpec with Matchers {
  ...
  it should "parse timestamp with millis and without timezone" in {
    format.parse("2014-01-01T01:02:03.004") should be (Some(new DateTime(2014, 1, 1, 1, 2, 3, 4).toDate))
  }

  it should "parse timestamp with short millis and without timezone" in {
    format.parse("2014-01-01T01:02:03.4") should be (Some(new DateTime(2014, 1, 1, 1, 2, 3, 400).toDate))
  }

  it should "parse timestamp with millis and timezone" in {
    format.parse("2014-01-01T01:02:03.004Z") should be (Some(new DateTime(2014, 1, 1, 3, 2, 3, 4).toDate))
  }

  it should "parse timestamp with millis and numeric timezone" in {
    format.parse("2014-01-01T01:02:03.004+02:00") should be (Some(new DateTime(2014, 1, 1, 1, 2, 3, 4).toDate))
  }

  it should "parse timestamp with short millis and timezone" in {
    format.parse("2014-01-01T01:02:03.4Z") should be (Some(new DateTime(2014, 1, 1, 3, 2, 3, 400).toDate))
  }
  ...
  it should "parse timestamp without millis and with numeric timezone" in {
    format.parse("2014-01-01T01:02:03+02:00") should be (Some(new DateTime(2014, 1, 1, 1, 2, 3).toDate))
  }
